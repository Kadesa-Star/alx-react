...
describe('Normalized data', () => {
  test('Normalized data should have correct result array', () => {
  ...
  test('Normalized data should have correct users entity', () => {
  ...
  test('Normalized data should have correct messages entity', () => {
  ...
  test('Normalized data should have correct notifications entity', () => {
