...
import { fetchNotifications } from '../actions/notificationActionCreators' // Import fetchNotifications action
...
const mapStateToProps = (state) => ({
        listNotifications: state.notifications.get('notifications').toArray(), // Convert Immutable to an array
        loading: state.notifications.get('loading'), // Assuming the loading state is stored in Redux
});
